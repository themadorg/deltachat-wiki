---
title: External Authentication Reference
description: Reference for the auth.external module, allowing Madmail to use external helper binaries for authentication.
category: Technical
---
