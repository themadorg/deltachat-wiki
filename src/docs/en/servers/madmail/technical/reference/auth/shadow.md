---
title: Shadow Authentication Reference
description: Reference for the auth.shadow module, enabling authentication via /etc/shadow or a setuid helper in Madmail.
category: Technical
---
