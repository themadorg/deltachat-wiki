---
title: Sender Authorization Reference
description: Reference for the check.authorize_sender module, which ensures sender addresses belong to the authenticated user.
category: Technical
---
