---
title: DKIM Verification Reference
description: Reference for the check.dkim module, which performs verification of DKIM signatures on incoming messages in Madmail.
category: Technical
---
