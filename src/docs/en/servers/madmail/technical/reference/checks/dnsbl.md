---
title: DNSBL Reference
description: Reference for the check.dnsbl module, enabling source IP and hostname checks against DNS-based Blackhole Lists (DNSBLs) in Madmail.
category: Technical
---
