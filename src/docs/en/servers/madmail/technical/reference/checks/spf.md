---
title: SPF Verification Reference
description: Reference for the check.spf module, which verifies if a client's IP is authorized for the sender's domain in Madmail.
category: Technical
---
