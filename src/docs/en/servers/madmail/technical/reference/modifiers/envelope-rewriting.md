---
title: Envelope Rewriting Reference
description: Reference for the replace_sender and replace_rcpt modules, used for rewriting SMTP envelope addresses in Madmail.
category: Technical
---
