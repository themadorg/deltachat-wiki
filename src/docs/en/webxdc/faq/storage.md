---
title: Questions about storing application state
description: Questions about storing application state documentation for webxdc.
category: FAQ
---
...
you must [send an application update](../specification/sendUpdate.html)
