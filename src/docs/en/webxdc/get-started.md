...
description: Learn how to build and share webxdc apps.
category: webxdc
order: 2
---
...
[watch "just web apps" on youtube](https://www.youtube.com/watch?v=I1K4pBvb2pI)
...
Even if you don't study the topic in depth, reading [Shared web application state](./shared-state/)
