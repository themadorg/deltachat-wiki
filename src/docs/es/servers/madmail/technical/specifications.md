---
title: Especificaciones seguidas
description: Lista de estándares de Internet y especificaciones seguidas por Madmail, incluyendo extensiones de IMAP y SMTP.
category: Técnico
---

# Especificaciones seguidas

Esta página enumera los estándares de Internet y otras especificaciones seguidas por maddy, junto con cualquier desviación conocida.
...
- [RFC 3501] - Internet Message Access Protocol - Version 4rev1
    * **Parcial**: A veces la bandera `\Recent` no se restablece.
- [RFC 2152] - UTF-7
...
- [RFC 6154] - IMAP LIST Extension for Special-Use Mailboxes
    * **Parcial**: Solo capacidad SPECIAL-USE.
- [RFC 5255] - Internet Message Access Protocol Internationalization
    * **Parcial**: Solo capacidad I18NLEVEL=1.
...
- [RFC 2920] - SMTP Service Extension for Command Pipelining
    * Solo soporte de servidor, no utilizado por el cliente SMTP.
...
- [RFC 7479] - Domain-based Message Authentication, Reporting, and Conformance (DMARC)
    * **Parcial**: Sin generación de informes.
...
### Autenticación de destinatarios
...
## Unicode, codificaciones, internacionalización
...
Existe una lista enorme de codificaciones ajenas a Unicode admitidas por el analizador sintáctico de mensajes utilizado para la caché estática y la búsqueda IMAP. Consulta la página de [Soporte Unicode](unicode-support.md) para más detalles.
