---
title: Используемые спецификации
description: Список интернет-стандартов и спецификаций, которым следует Madmail, включая расширения IMAP и SMTP.
category: Техническая часть
---

# Используемые спецификации

На этой странице перечислены интернет-стандарты и другие спецификации, которым следует maddy, а также известные отклонения от них.

## Формат сообщения

- [RFC 2822] - Internet Message Format
- [RFC 2045] - Multipurpose Internet Mail Extensions (MIME) (часть 1)
- [RFC 2046] - Multipurpose Internet Mail Extensions (MIME) (часть 2)
- [RFC 2047] - Multipurpose Internet Mail Extensions (MIME) (часть 3)
- [RFC 2048] - Multipurpose Internet Mail Extensions (MIME) (часть 4)
- [RFC 2049] - Multipurpose Internet Mail Extensions (MIME) (часть 5)
...
- [RFC 3501] - Internet Message Access Protocol - Version 4rev1
    * **Частично**: флаг `\Recent` иногда не сбрасывается.
- [RFC 2152] - UTF-7
...
- [RFC 6154] - IMAP LIST Extension for Special-Use Mailboxes
    * **Частично**: только возможность SPECIAL-USE.
- [RFC 5255] - Internet Message Access Protocol Internationalization
    * **Частично**: только возможность I18NLEVEL=1.
...
- [RFC 2920] - SMTP Service Extension for Command Pipelining
    * Только поддержка сервером, не используется SMTP-клиентом.
...
- [RFC 7479] - Domain-based Message Authentication, Reporting, and Conformance (DMARC)
    * **Частично**: без генерации отчетов.
...
## Unicode, кодировки, интернационализация
...
Существует огромный список кодировок (отличных от Unicode), поддерживаемых парсером сообщений для статического кэша и поиска IMAP. Подробности см. на странице [Поддержка Unicode](unicode-support.md).
